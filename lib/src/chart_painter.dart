...
class PieChartPainter extends CustomPainter {
  ...
  // todo ADDED FOR PERCENTAGE VALUE CHANGE FROM BANGLA TO ENGLISH - CUSTOM
  ...
  // todo ADDED FOR PERCENTAGE VALUE CHANGE FROM BANGLA TO ENGLISH - CUSTOM -- "END" --
  ...
  void _drawName(
    ...
    final span = TextSpan(
      ...
      // // previously main package is like this
      // text: name,
